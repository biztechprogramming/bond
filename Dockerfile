...
ARG NEXT_PUBLIC_STDB_HOST
ARG NEXT_PUBLIC_STDB_PORT=18787
ENV BOND_SPACETIMEDB_URL=${BOND_SPACETIMEDB_URL}
ENV NEXT_PUBLIC_STDB_HOST=${NEXT_PUBLIC_STDB_HOST}
ENV NEXT_PUBLIC_STDB_PORT=${NEXT_PUBLIC_STDB_PORT}
