...
const tablesSchema = __schema({
  ...
  workspace_graph_edges: __table({
    ...
    indexes: [
      ...
      { name: 'wge_source_node', algorithm: 'btree', columns: [
        'sourceNodeId',
      ] },
      { name: 'wge_target_node', algorithm: 'btree', columns: [
        'targetNodeId',
      ] },
      { name: 'wge_workspace_source', algorithm: 'btree', columns: [
        'workspaceId',
      ] },
    ],
    constraints: [
  ...
  workspace_graph_file_state: __table({
    ...
    indexes: [
      ...
      { name: 'wgfs_workspace', algorithm: 'btree', columns: [
        'workspaceId',
      ] },
    ],
    constraints: [
  ...
  workspace_graph_nodes: __table({
    ...
    indexes: [
      ...
      { name: 'wgn_workspace_type', algorithm: 'btree', columns: [
        'workspaceId',
      ] },
    ],
    constraints: [
  ...
  workspace_graph_provenance: __table({
    ...
    indexes: [
      { name: 'wgp_edge', algorithm: 'btree', columns: [
        'edgeId',
      ] },
      { name: 'id', algorithm: 'btree', columns: [
        'id',
      ] },
      { name: 'wgp_node', algorithm: 'btree', columns: [
        'nodeId',
      ] },
    ],
    constraints: [
  ...
  workspace_graph_runs: __table({
    ...
    indexes: [
      ...
      { name: 'wgr_workspace', algorithm: 'btree', columns: [
        'workspaceId',
      ] },
    ],
    constraints: [
