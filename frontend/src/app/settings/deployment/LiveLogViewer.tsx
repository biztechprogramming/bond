...
const styles: Record<string, React.CSSProperties> = {
  ...
  searchInput: { backgroundColor: "#16162a", color: "#e0e0e8", borderWidth: "1px", borderStyle: "solid", borderColor: "#3a3a5a", borderRadius: 6, padding: "6px 10px", fontSize: "0.8rem", flex: 1, minWidth: 150 },
  tab: { backgroundColor: "#12121a", color: "#8888a0", borderWidth: "1px", borderStyle: "solid", borderColor: "#1e1e2e", borderRadius: 6, padding: "4px 10px", fontSize: "0.75rem", cursor: "pointer" },
  activeTab: { backgroundColor: "#2a2a4a", color: "#e0e0e8", borderWidth: "1px", borderStyle: "solid", borderColor: "#6c8aff", borderRadius: 6, padding: "4px 10px", fontSize: "0.75rem", cursor: "pointer", fontWeight: 600 },
  ...
  logLine: { display: "flex", gap: 8, padding: "3px 12px", borderBottomWidth: "1px", borderBottomStyle: "solid", borderBottomColor: "#12121a", whiteSpace: "nowrap" as const },
  ...
  card: { backgroundColor: "#12121a", borderWidth: "1px", borderStyle: "solid", borderColor: "#1e1e2e", borderRadius: 12, padding: 16, display: "flex", flexDirection: "column", gap: 8 },
  cardTitle: { fontSize: "0.8rem", fontWeight: 600, color: "#8888a0", textTransform: "uppercase" as const },
  issueButton: { backgroundColor: "#4a2a2a", color: "#ff6c8a", borderWidth: "1px", borderStyle: "solid", borderColor: "#5a3a3a", borderRadius: 6, padding: "6px 12px", fontSize: "0.8rem", cursor: "pointer", fontWeight: 600 },
  secondaryButton: { backgroundColor: "#2a2a3e", color: "#e0e0e8", borderWidth: "1px", borderStyle: "solid", borderColor: "#3a3a4e", borderRadius: 6, padding: "6px 12px", fontSize: "0.8rem", cursor: "pointer" },
};
